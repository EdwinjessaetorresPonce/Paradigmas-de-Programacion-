...
class ClienteBancario:
    ...
    def __init__(self, nombres:str, apellidos:str, edad:int=0, balanceoDeCuenta:float=0.0):
        self.__validarEda(edad)
        self.__validarCantidad(balanceDeCuenta)
        self.nombres= nombres
        self.apellidos = apellidos
        self.__edad = edad
        self.balanceoDeCuenta = balanceoDeCuenta
    ...
    def imprimirEdad (self) -> str:
        return "Nombre: " + self.getNombreCompleto() + ", Edad: " + str(self.__edad) + ", Balance: " + str(self.__balnceDeCuenta)
    ...
    def retirarDinero(self, cantidad:float) -> None:
        cantidadFinal = balanceDeCuenta - cantidad
        self.__validarCantidad(cantidadFinal)
        self.balanceDeCuenta = cantidadFinal
        self.__mandarEmail("----retirando dienro----" , "se retiro " + str(cantidad))
        self.__enviarBalanceAlBanco(cantidad)
