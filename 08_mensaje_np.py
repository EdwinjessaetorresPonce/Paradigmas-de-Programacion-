...
#=============================================
# Se indica e tipo de datos   explicitamente
#=============================================
...
if rank == 0:
    ...
    comm.Recv([data, MPI.INT], source=0, tagg=77)
    print(data)
...
#===============================
if rank==0:
    data = numpy.arange(10, stype=numpy.float64)
    comm.Send(data, dest=1, tag=13)
    
elif rank == 1:
    data = numpy.empty(10, stype=numpy.float64)
